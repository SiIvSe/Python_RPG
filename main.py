    ...
    if option == "идти" or option == "вперёд" or option == "идти дальше":
        ...
        if wst < 0.3:
            ...
            if otv in sogl:
                ...
                shops = {'Магазин |': ['| 1 |', '| 2 |', '| 3 |', '| 4 |'],'товар или услуга |': ["Увеличить Атака |", "Увеличить хп |" , "сменить оружие |", "сменить имя |"],'цена |': [str(coast) + " |" , str(hpc) + " |", str(opt1) + " |", str(opt1//2) + " |"], "описание |": ["увеличите атаку на 5 |", "увеличите хп на 10 |", "Вы замените свое оружие |", "Вы замените свое Имя |"]}
